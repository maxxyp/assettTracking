define(["require", "exports", "../modules/appliances/viewModels/electricalSafetyViewModel", "../../business/models/applianceElectricalSafetyDetail", "../../business/models/applianceElectricalUnsafeDetail"], function (require, exports, electricalSafetyViewModel_1, applianceElectricalSafetyDetail_1, applianceElectricalUnsafeDetail_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ApplianceSafetyFactory = /** @class */ (function () {
        function ApplianceSafetyFactory() {
        }
        ApplianceSafetyFactory.prototype.createElectricalSafetyViewModel = function (applianceSafety, businessRules) {
            var vm = new electricalSafetyViewModel_1.ElectricalSafetyViewModel(businessRules);
        ...
        ApplianceSafetyFactory.prototype.createApplianceElectricalSafetyDetail = function (electricalSafetyViewModel) {
            var bm = new applianceElectricalSafetyDetail_1.ApplianceElectricalSafetyDetail();
        ...
        ApplianceSafetyFactory.prototype.createApplianceElectricalUnsafeDetail = function (electricalSafetyViewModel) {
            var bm = new applianceElectricalUnsafeDetail_1.ApplianceElectricalUnsafeDetail();
            if (electricalSafetyViewModel) {
