...
define(["require", "exports", "aurelia-framework", "../../../business/services/applianceService", "aurelia-event-aggregator", "../../../business/services/labelService", "aurelia-dialog", "../../../business/services/catalogService", "../../models/businessRulesViewModel", "../../../business/services/businessRuleService", "../../../business/services/validationService", "./appliancePageHelper"], function (require, exports, aurelia_framework_1, applianceService_1, aurelia_event_aggregator_1, labelService_1, aurelia_dialog_1, catalogService_1, businessRulesViewModel_1, businessRuleService_1, validationService_1, appliancePageHelper_1) {
    ...
    var PrevGasSafety = /** @class */ (function (_super) {
        __extends(PrevGasSafety, _super);
        function PrevGasSafety(labelService, applianceService, eventAggregator, dialogService, validationService, businessRuleService, catalogService) {
        ...
        PrevGasSafety.prototype.canActivateAsync = function () {
            var rest = [];
        ...
        PrevGasSafety.prototype.activateAsync = function (params) {
            var _this = this;
        ...
        PrevGasSafety.prototype.loadModel = function () {
            var _this = this;
        ...
        PrevGasSafety.prototype.loadCatalogs = function () {
            var _this = this;
            var catalogPromises = [
                this.buildYesNoList()
        ...
        PrevGasSafety.prototype.isModelEmpty = function (previous) {
            var isEmpty = false;
            if (previous) {
        ...
        return PrevGasSafety;
    }(businessRulesViewModel_1.BusinessRulesViewModel));
    exports.PrevGasSafety = PrevGasSafety;
});

//# sourceMappingURL=prevGasSafety.js.map
