...
define(["require", "exports", "aurelia-dependency-injection", "aurelia-http-client", "../../../core/services/configurationService", "../../models/geoPosition", "../../models/distanceTime", "../../../core/urlParamService", "../wua/constants/googleMapsServiceConstants", "../../../core/models/baseException"], function (require, exports, aurelia_dependency_injection_1, aurelia_http_client_1, configurationService_1, geoPosition_1, distanceTime_1, urlParamService_1, googleMapsServiceConstants_1, baseException_1) {
    "use strict";
    ...
    var GoogleMapsService = /** @class */ (function () {
        ...
        GoogleMapsService.prototype.launchMap = function (location) {
            return new Promise(function (resolve, reject) {
                ...
                var mapsUrl = "https://www.google.com/maps?q={location}";
        ...
        GoogleMapsService.prototype.launchDirections = function (origin, destination) {
            return new Promise(function (resolve, reject) {
                ...
                var mapsUrl = "https://www.google.com/maps?saddr={origin}&daddr={destination}";
