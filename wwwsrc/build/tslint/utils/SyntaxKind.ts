...
export module SyntaxKind {
    ...
    let cachedKinds: typeof ts.SyntaxKind;

    /* tslint:disable:variable-name */
    const SyntaxKind_1_5: typeof ts.SyntaxKind = <any> {
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_1_6: typeof ts.SyntaxKind = <any> {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
    ...
    /* tslint:disable:variable-name */
    const SyntaxKind_1_7: typeof ts.SyntaxKind = <any> {
        /* tslint:enable:variable-name */
        Unknown: 0,
        EndOfFileToken: 1,
        SingleLineCommentTrivia: 2,
    ...
    export function current(): typeof ts.SyntaxKind {
        if (cachedKinds == null) {
