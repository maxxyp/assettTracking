...
import com.assettracking.utils.SchemaValidator;
...
//                .all()
    ...
    @Then("^I can validate the schema$")
    public void i_can_validate_the_schema() {
        // Write code here that turns the phrase above into concrete actions
        System.out.println("-------- We are in validate Schema method ");
