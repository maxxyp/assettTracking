...
public class ResponseValidator {
    ...
    public static void validateResponse(Response response){
        ...
        Material material1 = constructMaterial("114063","Injector Gas Keston 80 Lpg Special","BGS","0","0","AreaG? ");
        Material material2 = constructMaterial("277860","Thermistor Sime Special","BGS","0","0","Staines");
